...
app.use((req, res, next) => {
    ...
    res.locals.signinHide = req.user ? true : false; // Hide sign-in button if user is logged in
    res.locals.navLinksHide = req.user ? false : true; // Hide navigation links if user is not logged in
    next();
});
